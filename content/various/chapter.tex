...
\section{Stress Test}
	\kactlimport[-l rawpy]{stress-test.py}
	\kactlimport[-l cpp]{gen.cpp}

\section{Java Cheat Sheet}
	\subsection{Java Template}
		\kactlimport[-l java]{Main.java}
	\subsection{BigInteger}

\section{Python Cheat Sheet}
	\subsection{Decimal}
		\kactlimport[-l rawpy]{Decimal.py}
